...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/data', ['data/pose_list_car1.txt']),  # change for opening the data file
        ('share/' + package_name + '/data', ['data/pose_list_car2.txt']),
    ...
    entry_points={
        'console_scripts': [
            ...
            'pose_estimate = gps_nav.pose_estimate:main',
            #'pose_estimate_converter = gps_nav.pose_estimate_converter:main',
            'pose_creator_vehicle = gps_nav.pose_creator_vehicle:main'
        ],
    },
)
