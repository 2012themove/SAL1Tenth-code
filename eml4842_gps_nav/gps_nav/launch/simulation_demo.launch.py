    ...
    return LaunchDescription([
        Node(
            ...
            parameters = [
                ...
                {'pose_filename_car2': config_dir + '/data/pose_list_car2.txt'}
            ]
        ),
        Node(
            package='gps_nav',
        ...
        Node(
            ...
            output='screen',
            parameters = [
                {'starting_position': [1.0, -4.0, 0.0]},  # UTM coords + 10 E from path start
                {'starting_ang_deg': 180.0},
                {'starting_position_car2': [4.0, -4.0, 0.0]},
                {'starting_ang_deg_car2': 180.0},
                {'L_wheelbase_m': 0.33}  # dist between axles in meters
